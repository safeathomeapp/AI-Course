...
Use this file for stable terminology. Do not use it as a substitute for worked examples, exercise design, or mental models.
...
| Verification | Human checking of claims, assumptions, and evidence before use. | A key part of human review before output is used in real work. | Cross-checking figures against source spreadsheet. |
...
## Practical Reminder
A strong workflow is: `Prompt -> Context -> Generation -> Human Review -> Decision`.
